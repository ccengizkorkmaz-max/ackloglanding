export const complianceGeneralArticles = {
  "verbis-kayit-zorunluluklari-nelerdir": {
    ...
    content: `
      <h2>KVKK Uyum Süreci: VERBİS Nedir ve Kimler Kaydolmalıdır?</h2>
  ...
  "kvkk-idari-para-cezalari-2026-analizi": {
    ...
    content: `
      <h2>Ekonomik Risk: KVKK Cezaları Katlanıyor</h2>
  ...
  "kvkk-uyumlu-log-saklama-suresi-nedir": {
    ...
    content: `
      ...
      <p>Logları sonsuza kadar saklamak disk maliyetidir, erken silmek ise hapis ve para cezası riskidir. KVKK gereği loglar "Gerektiği kadar" (Genellikle 2 yıl) saklanmalıdır.</p>
