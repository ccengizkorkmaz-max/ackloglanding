...
<p><strong>Soru:</strong> Her kaynaktan log alabiliyor musunuz?<br/><strong>Cevap:</strong> Evet, Firewall, Switch, Windows/Linux sunucular ve özel yazılımlardan Syslog, WMI veya Agent ile log toplanabilmektedir.</p>`
  ...
  "sql-server-audit-log-toplama": {
    ...
    content: `
      ...
      <ol class="list-decimal pl-6 space-y-2 mb-6">
        <li><strong>Sadece Kritik Tablolar:</strong> Her şeyi değil, sadece <a href="/wiki/kvkk-siem-log-yonetimi-rehberi" class="text-blue-400 hover:underline font-bold">KVKK</a> kapsamındaki tablo erişimlerini loglayarak performansı koruyun.</li>
...
<p><strong>Soru:</strong> Her kaynaktan log alabiliyor musunuz?<br/><strong>Cevap:</strong> Evet, Firewall, Switch, Windows/Linux sunucular ve özel yazılımlardan Syslog, WMI veya Agent ile log toplanabilmektedir.</p>`
  ...
  "log-korelasyon-kurallari-ornekleri": {
    ...
    content: `
      <h2>Zeki Güvenlik: Log <a href="/wiki/siem-nedir" class="text-blue-400 hover:underline font-bold">Korelasyon</a> Kuralları Örnekleri ve Analizi</h2>
      <blockquote class="border-l-4 border-blue-500 pl-4 py-2 my-6 bg-slate-900/50 italic text-gray-300">
        *Siber güvenlik raporlarına göre, SIEM kullanılan altyapılarda tehdit tespit süresi (MTTD) %80 oranında kısalmaktadır.*
      </blockquote>
      <p>
...
<p><strong>Soru:</strong> EPS lisanslamanın dezavantajı nedir?<br/><strong>Cevap:</strong> EPS bazlı modellerde kurumunuz büyüdükçe faturanız da büyür; sınırsız EPS destekleyen çözümler daha uzun vadeli ROI sunar.</p>`
  ...
  "siem-uzerinde-alarm-olusturma": {
    ...
    content: `
      ...
      <p><strong>Profesyonel Tavsiye:</strong> Sitemizden <strong>"Top 50 <a href="/wiki/soc-kurulum-rehberi-maliyetler" class="text-blue-400 hover:underline font-bold">SOC</a> Alarm Senaryosu"</strong> dökümanını indirerek kendi kurallarınızı oluşturmaya başlayın.</p>
